...
local rhox_torinubar_event_tables = {
    ...
    { function(world_conditions)
        ...
        function(event_conditions, caravan_handle)
            ...
            local dilemma_list = { "rhox_torinubar_dilemma_cth_caravan_battle_1A",
                "rhox_torinubar_dilemma_cth_caravan_battle_1B" }
    ...
    { function(world_conditions)
        ...
        function(event_conditions, caravan_handle)
            ...
            local dilemma_list = { "rhox_torinubar_dilemma_cth_caravan_battle_2A",
                "rhox_torinubar_dilemma_cth_caravan_battle_2B" }
            local dilemma_name = dilemma_list[cm:random_number(2, 1)];
            local caravan = caravan_handle;
    ...
    { function(world_conditions)
        ...
        local special_units = { "wh2_main_hef_mon_sun_dragon", "wh2_main_hef_art_eagle_claw_bolt_thrower",
            "wh2_main_hef_cav_dragon_princes", "wh2_main_hef_mon_phoenix_flamespyre",
        ...
        function(event_conditions, caravan_handle)
            ...
            payload_builder:add_unit(caravan_handle:caravan_force(), special_units[cm:random_number(#special_units, 1)],
                1, 0);
            dilemma_builder:add_choice_payload("SECOND", payload_builder);
            payload_builder:clear();
    ...
    { function(world_conditions)
        ...
        function(event_conditions, caravan_handle)
            ...
            local ranged_list = { "wh2_main_hef_cav_tiranoc_chariot", "wh2_dlc10_hef_inf_shadow_walkers_0",
                "wh2_dlc10_hef_inf_shadow_warriors_0", "wh2_dlc10_hef_inf_sisters_of_avelorn_0" };
            local melee_list = { "wh2_dlc15_hef_inf_silverin_guard_0", "wh2_main_hef_inf_spearmen_0",
                "wh2_main_hef_inf_white_lions_of_chrace_0", "wh2_main_hef_cav_silver_helms_1" };
    ...
    { function(world_conditions)
        ...
        function(event_conditions, caravan_handle)
            ...
            local ranged_list = { "wh2_main_hef_inf_lothern_sea_guard_1", "wh2_main_hef_inf_archers_1",
                "wh2_dlc10_hef_inf_shadow_warriors_0" };
            local melee_list = { "wh2_dlc15_hef_inf_silverin_guard_0", "wh2_main_hef_inf_phoenix_guard",
                "wh2_main_hef_inf_swordmasters_of_hoeth_0", "wh2_main_hef_cav_ithilmar_chariot" };
...
function rhox_torinubar_attach_battle_to_dilemma(
    ...
    if attacking_force ~= nil then
        enemy_force_cqi, x, y = caravans:spawn_caravan_battle_force(caravan, attacking_force, target_region, is_ambush,
            false, enemy_faction)                                                                                                       --we don't need new function for these
    end
...
function rhox_torinubar_generate_attackers(bandit_threat, force_name)
    ...
    if bandit_threat < 50 then
        force_name = { "rhox_torinubar_def_dark_elves_qb1_low_a", "rhox_torinubar_cst_vampire_coast_qb1_low_a",
            "rhox_torinubar_nor_norsca_qb1_low_a", "rhox_torinubar_def_dark_elves_qb1_low_b",
            "rhox_torinubar_cst_vampire_coast_qb1_low_b", "rhox_torinubar_nor_norsca_qb1_low_b" }
    ...
    elseif bandit_threat >= 50 and bandit_threat < 70 then
        force_name = { "rhox_torinubar_def_dark_elves_qb1_med_a", "rhox_torinubar_cst_vampire_coast_qb1_med_a",
            "rhox_torinubar_nor_norsca_qb1_med_a", "rhox_torinubar_def_dark_elves_qb1_med_b",
            "rhox_torinubar_cst_vampire_coast_qb1_med_b", "rhox_torinubar_nor_norsca_qb1_med_b" }
        local target_force = force_name[cm:random_number(#force_name, 1)]
        local enemy_faction_name = force_to_faction_name[target_force]
        return random_army_manager:generate_force(target_force, 11, false), enemy_faction_name;
    elseif bandit_threat >= 70 then
        force_name = { "rhox_torinubar_def_dark_elves_qb1_high_a", "rhox_torinubar_cst_vampire_coast_qb1_high_a",
            "rhox_torinubar_nor_norsca_qb1_high_a", "rhox_torinubar_def_dark_elves_qb1_high_b",
            "rhox_torinubar_cst_vampire_coast_qb1_high_b", "rhox_torinubar_nor_norsca_qb1_high_b" }
        local target_force = force_name[cm:random_number(#force_name, 1)]
        local enemy_faction_name = force_to_faction_name[target_force]
...
local function rhox_torinubar_start_listeners()
    ------------------------------listeners
...
cm:add_first_tick_callback(
    function()
        ...
        rhox_torinubar_start_listeners()
        ------rhox-----------------
        if cm:get_local_faction_name(true) == torinubar_faction_key then --ui thing and should be local
            core:add_listener(                                          --this is where changing all the localization, resource for Torinubar happens
                ...
                function()
                    ...
                    local resource_holder = find_uicomponent(core:get_ui_root(), "military_convoys", "left_panel",
                        "content_list", "header_container", "resource_list");
                    ...
                    local result = core:get_or_create_component("rhox_torinubar_convoy_panel_east.twui.xml",
                        "ui/campaign ui/rhox_torinubar_convoy_panel_east.twui.xml", resource_holder)
                    local result2 = core:get_or_create_component("rhox_torinubar_convoy_panel_west.twui.xml",
                        "ui/campaign ui/rhox_torinubar_convoy_panel_west.twui.xml", resource_holder)
                end,
                true
            )
        end
