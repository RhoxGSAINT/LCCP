...
rhox_zach_book_objective_list_faction = {
        {objective = "CAPTURE_REGIONS", target = "cr_oldworld_region_altdorf"},
		{objective = "CAPTURE_REGIONS", target = "cr_oldworld_region_silver_pinnacle"},
		{objective = "CAPTURE_REGIONS", target = "cr_oldworld_region_doom_keep"},
		{objective = "CAPTURE_REGIONS", target = "cr_oldworld_region_citadel_of_lead"},
		{objective = "ENGAGE_FORCE", target = "wh2_dlc09_rogue_black_creek_raiders", pos = {x = 528, y = 1021}, patrol = patrol_me_black_creek_raiders},
		{objective = "ENGAGE_FORCE", target = "wh2_dlc09_rogue_eyes_of_the_jungle", pos = {x = 822, y = 785}, patrol = patrol_me_eyes_of_the_jungle},
		{objective = "ENGAGE_FORCE", target = "wh2_dlc09_rogue_dwellers_of_zardok", pos = {x = 701, y = 317}, patrol = patrol_me_dwellers_of_zardok},
		{objective = "ENGAGE_FORCE", target = "wh2_dlc09_rogue_pilgrims_of_myrmidia", pos = {x = 192, y = 665}, patrol = patrol_me_pilgrims_of_myrmidia}
};
...
cm:add_first_tick_callback(
    function()
        if cm:get_faction("cr_vmp_the_everliving"):is_human() then
            if cm:is_new_game() == true then
                rhox_zach_setup_nagash_book_missions("cr_vmp_the_everliving", true, false);
...
local zach_faction_key = "cr_vmp_the_everliving"
...
function zach_malevolant_museum_effect_update()
	local region = cm:get_region("cr_oldworld_region_roezfels")
