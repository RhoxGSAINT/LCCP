core:add_ui_created_callback(
    function(context)
        if vfs.exists("script/frontend/mod/mixer_frontend.lua")then
            ...
            mixer_add_starting_unit_list_for_faction("rhox_nor_ravenblessed", {"wh_dlc08_nor_inf_marauder_hunters_1","wh3_dlc24_tze_mon_cockatrice","wh_main_nor_inf_chaos_marauders_0","wh3_dlc20_chs_cav_chaos_chariot_mtze","wh3_dlc20_chs_cav_marauder_horsemen_mtze_javelins","wh_dlc08_nor_inf_marauder_spearman_0",})
            ...
            mixer_add_starting_unit_list_for_faction("cr_kho_servants_of_the_blood_nagas", {"wh3_main_kho_inf_chaos_warriors_0","wh3_main_kho_cav_skullcrushers_0","wh3_main_kho_inf_bloodletters_0","wh3_main_kho_inf_chaos_warriors_1"})
            ...
            mixer_add_starting_unit_list_for_faction("rhox_chs_the_deathswords", {"wh_dlc01_chs_inf_chaos_warriors_2","wh_main_chs_mon_giant","wh_dlc01_chs_inf_chosen_2"})
            ...
            mixer_add_starting_unit_list_for_faction("cr_tmb_sons_of_ptra", {"wh2_dlc09_tmb_inf_skeleton_spearmen_0","wh2_dlc09_tmb_mon_tomb_scorpion_0","wh2_dlc09_tmb_mon_carrion_0","wh2_dlc09_tmb_inf_skeleton_warriors_0"})
